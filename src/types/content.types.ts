...
export interface About extends BasePageConfig {
  ...
  publications: {
    ...
    items: Array<{
      ...
      /** Description/summary */
      description: React.ReactNode;
      /** Link to the publication (e.g., Amazon) */
      link: string;
      /** Cover image path */
      image?: string;
    }>;
...
/**
 * LifeHacks page configuration.
 * @description Configuration for the LifeHacks page - a mind dump of useful life tips and insights.
 */
export interface LifeHacks extends BasePageConfig {}
